...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/956.png"))
        # 图片读取进程
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        img_detection_title = QLabel("手势图片识别功能")
        img_detection_title.setFont(font_title)
        mid_img_widget = QWidget()
        mid_img_layout = QHBoxLayout()
        self.left_img = QLabel()
        self.right_img = QLabel()
        self.left_img.setPixmap(QPixmap("images/UI/956.png"))
        self.right_img.setPixmap(QPixmap("images/UI/956.png"))
        ...
        up_img_button.setStyleSheet("QPushButton{color:white}"
                                    ...
                                    "QPushButton{background-color:rgb(128,138,195)}"
        ...
        det_img_button.setStyleSheet("QPushButton{color:white}"
                                     ...
                                     "QPushButton{padding:5px 5px}"
                                     "QPushButton{margin:5px 5px}")
        img_layout.addWidget(up_img_button)
        img_layout.addStretch(0)
        img_layout.addWidget(det_img_button)
        img_widget.setLayout(img_layout)

        img_detection_layout.addWidget(img_detection_title, alignment=Qt.AlignCenter)
        img_detection_layout.addWidget(mid_img_widget, alignment=Qt.AlignCenter)
        img_detection_layout.addWidget(img_widget, alignment=Qt.AlignCenter)
        ...
        self.webcam_detection_btn = QPushButton("摄像头")
        self.mp4_detection_btn = QPushButton("视频文件")
        ...
        video_layout.addWidget(self.webcam_detection_btn)
        video_layout.addStretch(0)
        video_layout.addWidget(self.mp4_detection_btn)
        video_layout.addStretch(0)
        video_layout.addWidget(self.vid_stop_btn)
        video_widget.setLayout(video_layout)

        # 添加组件到布局上
        vid_detection_layout.addWidget(vid_title)
        vid_detection_layout.addWidget(self.vid_img)
        vid_detection_layout.addWidget(video_widget, alignment=Qt.AlignCenter)
        ...
        self.setTabIcon(0, QIcon('images/UI/956.png'))
        self.setTabIcon(1, QIcon('images/UI/956.png'))
